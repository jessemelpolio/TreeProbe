...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--datasets", type=str, default="CIFAR10,SVHN,Resisc45")
        parser.add_argument(
            "--mixed_datasets",
            type=str,
            default="EuroSAT,CIFAR100,OxfordIIITPet,Caltech101",
        )
        parser.add_argument("--held_out_dataset", type=str, default="Caltech101")
        ...
        parser.add_argument("--img_threshold", type=float, default=0.75)
        parser.add_argument("--text_threshold", type=float, default=0.25)
        # parser.add_argument('--prec_list', type=list, default=None)
        # Model settings
        ...
        # Training settings
        parser.add_argument("--engine", type=str, default="learnable")
