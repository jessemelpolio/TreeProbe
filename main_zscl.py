...
from engines.zscl_engine import ZSCLEngine
...
if __name__ == "__main__":
    ...
    # get image reference datasets
    ref_image_dataset, _ = get_image_dataset_with_name(args, args.ref_image_dataset)

    # get caption reference datasets
    ref_caption_dataset = get_conceptual_captions_dataset(args)
    ...
    for i in range(incremental_train_dataset.num_stages):
        ...
        engine.fit(
            ...
            stage=i,
            reference_image_dataset=ref_image_dataset,
            reference_captions=ref_caption_dataset,
        )
